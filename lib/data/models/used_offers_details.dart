...
UsedOffersDetailsModel usedOffersDetailsModelFromJson(String str) =>
    UsedOffersDetailsModel.fromJson(json.decode(str));

String usedOffersDetailsModelToJson(UsedOffersDetailsModel data) =>
    json.encode(data.toJson());

class UsedOffersDetailsModel {
  bool? status;
  String? message;
  Data? data;

  UsedOffersDetailsModel({
    this.status,
    this.message,
    this.data,
  });

  factory UsedOffersDetailsModel.fromJson(Map<String, dynamic> json) =>
      UsedOffersDetailsModel(
        status: json["status"],
